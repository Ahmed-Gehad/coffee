            ...
            <div className="container mx-auto grid lgl:grid-cols-[2fr_1fr] gap-10">
                ...
                <motion.div
                    ...
                    <form className='mt-5'>
                        ...
                        <button
                            type="submit"
                            className="px-6 py-3 bg-[#F97316] font-bold hover:bg-[#1E1E1E] hover:text-[#F97316] rounded-full text-white font-semibold  
                ...
                <motion.div
                    ...
                    <form  className='mt-5'>
                        ...
                        <button
                            type="submit"
                            className="w-full px-6 py-2 bg-[#F97316] font-bold hover:bg-[#1E1E1E] hover:text-[#F97316] rounded-md text-white font-semibold  
                                        shadow-md   focus:outline-none focus:ring-2
                                        focus:ring-orange-500 transition duration-700">
                            Submit
                        </button>
